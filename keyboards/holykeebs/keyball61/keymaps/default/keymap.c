...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_universal(
    ...
    HK_I_SCROLL , _______  , KC_7     , KC_8     , KC_9     , _______  ,                                  _______  , KC_LEFT  , KC_UP    , KC_RGHT  , _______  , KC_F12   ,
  ...
  [3] = LAYOUT_universal(
    ...
    RM_NEXT  , RM_HUEU  , RM_SATU  , RM_VALU  , _______  , _______  ,                                  _______  , _______  , _______  , _______  , _______  , _______  ,
    RM_PREV  , RM_HUED  , RM_SATD  , RM_VALD  , _______  , _______  ,                                  HK_P_SET_D, HK_P_SET_S, HK_P_SET_THR, _______, HK_SAVE  , HK_RESET ,
    _______  , _______  , HK_S_MODE, HK_S_MODE_T, HK_D_MODE, HK_D_MODE_T, EE_CLR ,            EE_CLR   , KC_HOME  , KC_PGDN  , KC_PGUP  , KC_END   , _______  , _______  ,
