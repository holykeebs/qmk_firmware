...
*The holykeebs build of Yowkees' Keyball61: RP2040, a 34 mm trackball on either or both halves, OLEDs, per-key RGB Matrix.*
...
* Hardware Supported: [Keyball61](https://github.com/Yowkees/keyball) PCB with an RP2040 controller
...
Make example for this keyboard (after setting up your build environment):
    ...
    make holykeebs/keyball61:via -e OLED=yes

Flashing example for this keyboard:

    make holykeebs/keyball61:via:flash -e OLED=yes
