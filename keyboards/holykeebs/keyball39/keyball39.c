...
// Matrix mask: marks the unused intersections so QMK ignores them (the
// hand-detection grid and the unused column). Consumed by the matrix scan
// because MATRIX_MASKED is defined in config.h.
// clang-format off
