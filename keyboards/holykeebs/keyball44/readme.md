...
*The holykeebs build of Yowkees' Keyball44: RP2040, a 34 mm trackball on either or both halves, OLEDs, per-key RGB Matrix.*
...
* Hardware Supported: [Keyball44](https://github.com/Yowkees/keyball) PCB with an RP2040 controller
...
Make example for this keyboard (after setting up your build environment):
    ...
    make holykeebs/keyball44:via -e OLED=yes

Flashing example for this keyboard:

    make holykeebs/keyball44:via:flash -e OLED=yes
